...
def number_tracks(data, day, city):
    track_list = data[(data['city'] == city) & (data['weekday'] == day)]
...
data_cities_days = [['Moscow', 15347, 10865, 15680], ['Saint-Petersburg', 5519, 6913, 5802]]
columns = ['city', 'monday', 'wednesday', 'friday']
table = pd.DataFrame(data = data_cities_days, columns = columns)
table
...
def genre_weekday(data, day, time1, time2):
    genre_list = data[(data['weekday'] == day) & (data['time'] > time1) & (data['time'] < time2)]
    genre_list_count = genre_list.groupby('genre_name')['track_name'].count()
    genre_list_sorted = genre_list_count.sort_values(ascending = False).head(10)
